...
rem ffmpeg -y -canvas_size 1024x576 -ss 00:00:00.3 -i "%%f" -vcodec nvenc -filter_complex "[0:v]setpts=PTS-STARTPTS[v0];[0:s]setpts=PTS-STARTPTS-1/TB[s0];[s0]scale=width=2732:height=1080[sub];[v0][sub]overlay=x=0:y=0" -map_chapters -1 -ac 2 "MP4\%%~nf.mp4"
...
-filter_complex "[0:s]scale=width=1920:height=1080[sub];[0:v][sub]overlay=x=0:y=0" ^
-c:a libfdk_aac ^
-ac 2 ^
